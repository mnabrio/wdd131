...
function searchList(list, queryString) {
  function searchCallback(item) {
    // return item.toLowerCase().includes(queryString.toLowerCase()); //includes - belong to all string, search substring if inside
...
// console.log("post-sort", simpleList); //using sort
// console.log("sorted", simpleSort); //show that list is modified
